...
<div class="container">
    ...
    <div class="jumbotron" style="margin-top: 20px;">
        <h1>el.com</h1>
        <p class="lead">Welcome to Electronic Library</p>
        <sec:authorize access="!isAuthenticated()">
            <p><a class="btn btn-lg btn-success" href="<c:url value="/login" />" role="button">Singin</a></p>
        </sec:authorize>
        <sec:authorize access="isAuthenticated()">
    ...
    <div class="footer">
        <p>&copy; Electronic Library 2017</p>
    </div>
